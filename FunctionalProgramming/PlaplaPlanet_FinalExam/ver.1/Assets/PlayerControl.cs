...
public class PlayerControl : MonoBehaviour {
    ...
    static public bool bAttcek =false;

    public GameObject childObjcet;
  ...
  static  public int temp;
    ...
    private void get_input()
    {
        ...
        this.key.atteck = Input.GetKeyDown(KeyCode.A);
    ...
    private void move_control()
    {
        ...
        bool is_moved = false;
        if (this.key.right&&!this.key.atteck)
        { // →키가 눌렸으면.
    ...
    void OnGUI()
    {
        ...
        switch (this.step)
        {
            case STEP.EATING:
                if (PlayerHp.Hp <= 980)
                {
                    PlayerHp.Hp = PlayerHp.Hp + 20;
                }
                else if (PlayerHp.Hp > 980)
                {
                    PlayerHp.Hp = 1000;
                }
    ...
    void Start () {
        ...
        this.childObjcet = GameObject.Find("WomanWarrior");
        this.anim = childObjcet.GetComponent<Animator>();
        temp = 0;
    }
