...
public class ItemRoot : MonoBehaviour {
	...
	void Update () {
        mTime = (mTime + Time.deltaTime)%120;
        if(mTime<60)
        {
            day = true;
        }
        ...
        respawn_timer_apple += PlayerControl.temp+Time.deltaTime;
        respawn_timer_iron += PlayerControl.temp+Time.deltaTime;
        respawn_timer_plant += PlayerControl.temp+Time.deltaTime;
